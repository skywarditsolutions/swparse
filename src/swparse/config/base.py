...
class ServerSettings:
    ...
    APP_LOC: str = "swparse.asgi:swparse"
    """Path to swparse executable, or factory."""
...
class AppSettings:
    ...
    NAME: str = field(default_factory=lambda: "swparse")
    """Application name."""
...
@dataclass
class AISettings:
    HF_TOKEN: str = field(default_factory=lambda: os.getenv("AI_HF_TOKEN", "xyz"))
    DEVICE: str = field(default_factory=lambda: os.getenv("AI_DEVICE", "cuda"))


@dataclass
class MinioSettings:
    STORAGE_LOCATION: str = field(default_factory=lambda: os.getenv("MINIO_STORAGE_LOCATION", "./data"))
    PORT: int = field(default_factory=lambda: int(os.getenv("MINIO_PORT", 9000)))
...
class Settings:
    ...
    storage: MinioSettings = field(default_factory=MinioSettings)
