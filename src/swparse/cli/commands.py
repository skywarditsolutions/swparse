...
async def load_database_fixtures() -> None:
    ...
    from swparse.db.models import Role
...
def create_user(
    ...
    from swparse.domain.accounts.schemas import UserCreate
...
def promote_to_superuser(email: str) -> None:
    ...
    from swparse.config.app import alchemy
    from swparse.domain.accounts.schemas import UserUpdate
...
def create_default_roles() -> None:
    ...
    from swparse.config.app import alchemy
    from swparse.db.models import UserRole
